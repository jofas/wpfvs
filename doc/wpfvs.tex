...
\include{./technologies/technologies}
\include{./app/app}

hallo \cite{ct_math,bio}
...
%  \item gym
%
%  \item architecture (8-10ps) (network (queues, exchanges,
%    etc.), generator and executor (algorithm for data
%    sanitation))
%
%  \item results (incl.\ difficulties (bottleneck data parsing))
%
%  \item where to go (loadbalancing, dynamic setting)
%
%\end{itemize}
%
%\begin{tikzpicture}
